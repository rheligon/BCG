...
urlpatterns = patterns('',
    ...
    url(r'^procd/mPropuestos/((?P<cuenta>[\w\s\$]+)/)?$', 'Matcher_WS.views.pd_matchesPropuestos', name='matchesPropuestos'),
    url(r'^procd/pAbiertas/$', 'Matcher_WS.views.pd_partidasAbiertas', name='partidasAbiertas'),
    url(r'^procd/mConfirmados/((?P<cuenta>[\w\s\$]+)/)?$', 'Matcher_WS.views.pd_matchesConfirmados', name='matchesConfirmados'),
    url(r'^procd/rep_conc/$', 'Matcher_WS.views.pd_conciliacion', name='pd_conciliacion'),
    url(r'^procd/detallesMT/((?P<mensaje>\w+)/)((?P<tipo>\w+)/)((?P<cuenta>[\w\s\$]+)/)?$', 'Matcher_WS.views.pd_detallesMT', name='detallesMT'),
